...
# HOURS_IN_A_DAY = 24
# HOURS_IN_A_MONTH = 730.484397
# HOURS_IN_A_YEAR = 8765.81278
# DAYS_IN_A_MONTH = 30.4368499
...
class CategoryDto:
    ...
    def __str__(self) -> str:
        to_string = f'CategoryDto[platform_id:{self._platform_id},name:\'{self._name}\',descritpion:\'{self._description}\',password_retention_period:{self._password_retention_period}]'
        return DomainUtils.correct_obj_str_format(to_string)
