...
class HostDto:
    ...
    @dispatch(int,Credentials)
    def __init__(self, host_id: int,credentials:Credentials):
        self._id = host_id
    ...
    def __str__(self) -> str:
        to_string = f'HostDto[user_id:\'{self._user_id}\',host_id:\'{self._id}\',host_name:\'{self._name}\',platform_id:\'{self._platform_id}\',category_name\'{self._category_name}\',address:\'{self._address}\',credentials:{self._credentials},custom_pwd_retention_period_in_hours:\'{self._custom_pwd_retention_period_in_hours}\']'
